...
public class TraineeDetailDTO {
    ...
    public TraineeDetailDTO(Long id, String lastName, String forename, String jobName, Date birthday, Date start_of_training, String departmentName, String locationName) {
        this.id = id;
